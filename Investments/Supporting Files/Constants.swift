...
class Constants : NSObject {
    ...
    //App colours
    static let mainTextGrey = UIColor(hexString: "E7E5E5")!
    static let titleTextGrey = UIColor(hexString: "B7B7B7")!
    static let placeholderGrey = UIColor(hexString: "424247")!
    static let yellow = UIColor(hexString: "F5B316")!
